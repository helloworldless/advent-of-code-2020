...
class Day3Test {
    ...
    void treeCountForTrajectory() {
        ...
        assertThat(grid.treeCountForTrajectory(3, 1)).isEqualTo(7);
        assertThat(grid.treeCountForTrajectory(5, 1)).isEqualTo(3);
        assertThat(grid.treeCountForTrajectory(7, 1)).isEqualTo(4);
        assertThat(grid.treeCountForTrajectory(1, 2)).isEqualTo(2);
    }
